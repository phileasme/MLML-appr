...
class KNearestNeighbor(object):
    ...
    # def l_custom_distance(self, test_point)
...
# If we have multilabels.. we can use Hamming distance, it determines in a binary fashion (is or isn't).
# However otherwise we could simply compare by taking absolute l1 distance.. 
# Ignore if it's a 0? 
def classification_comparaison():
